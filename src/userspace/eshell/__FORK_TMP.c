...
//
// Unfinished stuff for adding pipe support to the shell
//
...
#define MAX_PIPES 64
	...
	const char *arg1[] = { "/bin/cat", "main.c", NULL };
	const char *arg2[] = { "../grep/grep", "sig", NULL };
	const char *arg3[] = { "../grep/grep", "nal", NULL };
